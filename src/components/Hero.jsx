...
const Hero = () => {
    return (
        <section className='relative min-h-screen flex items-center justify-center overflow-hidden pt-24 pb-16 md:pt-28 md:pb-28 lg:pt-36 lg:pb-48' id="home">
            ...
            <div className='container relative z-10'>
                <div className='flex flex-col items-center text-center max-w-5xl mx-auto'>
                    ...
                    {/* Headline */}
                    <div className="mb-8 md:mb-20 lg:mb-28 overflow-hidden">
                        <motion.h1 
                            initial={{ y: "100%" }}
                            animate={{ y: 0 }}
                            transition={{ duration: 1, ease: [0.16, 1, 0.3, 1] }}
                            className='text-4xl xs:text-5xl md:text-8xl lg:text-[7.5rem] leading-[1.0] uppercase relative z-30'
                        >
                    ...
                    <motion.div
                        ...
                        className="flex flex-col md:flex-row items-center justify-center gap-2 md:gap-6 lg:gap-10 text-[10px] md:text-sm lg:text-[14px] font-bold text-white/70 tracking-[0.15em] uppercase mb-10 md:mb-24 lg:mb-32 font-sans"
                    >
                    ...
                    <motion.div 
                        ...
                        className="relative w-full max-w-2xl h-auto md:h-48 mb-10 md:mb-28 lg:mb-36 flex flex-col md:flex-row items-center justify-center gap-3 md:gap-6"
                    >
                        {/* Wander Through Works (Left stylized leaf node) */}
                        <a 
                            href="#projects" 
                            className="md:absolute md:left-4 lg:left-12 md:top-4 p-4 md:p-8 bg-primary/95 text-bg border border-primary/50 rounded-tl-3xl rounded-br-3xl rounded-tr-lg rounded-bl-lg shadow-[inset_0_1px_4px_rgba(255,255,255,0.25),0_0_35px_rgba(134,193,149,0.45)] hover:shadow-[inset_0_1px_4px_rgba(255,255,255,0.4),0_0_55px_rgba(134,193,149,0.7)] transition-all duration-500 hover:scale-105 group overflow-hidden animate-float w-full max-w-[240px] md:w-56 text-center block"
                        >
                    ...
                    >
                        <div className="flex items-center justify-center gap-4 mb-4">
                            ...
                            <p className="text-[10px] font-bold text-white/60 uppercase tracking-[0.2em]">Root Technologies</p>
                            <div className="h-[1px] w-12 bg-white/10"></div>
                        </div>
                        <div className="flex flex-wrap justify-center gap-5 md:gap-8 lg:gap-12 xl:gap-20 px-2 md:px-4">
